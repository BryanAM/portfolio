  ...
  return (
    <div className="max-content-width">
      <Stack className="resume" flexDirection="column">
        <Stack
          className="resume-headers resume-stack"
        ...
        >
          ...
          <div>
            ...
            <a
              className="resume-download-button text-button"
              title="download"
              href={resume}
              download="bryan_aument.pdf"
            >
        ...
        <Stack className="resume-stack" flexDirection="column">
          <h3 className="resume-section-header resume-highlighted-item">
          ...
          <h3 className="resume-stack resume-section-header resume-highlighted-item">
            {t("resume.educationTech")}
          </h3>
          <Stack justifyContent="space-between">
            <Stack flexDirection="column">
              {t("resume.schools", { returnObjects: true }).map(
                (school, index) => (
            ...
            <Stack flexDirection="column">
              {t("resume.techStack", { returnObjects: true }).map(
                (tech, index) => (
